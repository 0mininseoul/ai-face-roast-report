  ...
  ko: [
    ...
    },
    {
      ...
      body: [
        ...
        "진단용 카메라 프레임은 분석 실패 또는 장시간 지연 원인 파악을 위해 최종 분석 요청 이미지와 별도로 저장될 수 있으며, 원칙적으로 Vertex AI Gemini 등 외부 AI 분석 API 입력으로 사용되지 않습니다. 최종 보고서 생성에는 기존 분석 흐름에서 정한 별도의 캡처 시점 이미지와 산출 메트릭이 사용됩니다.",
