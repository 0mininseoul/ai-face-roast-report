...
const sections = [
  {
    ...
    body: [
      ...
      "본 약관은 서비스의 웹 화면, 카메라 접근 기능, 얼굴 랜드마크 분석 기능, Gemini 기반 문장 생성 기능, 결과 페이지 생성 및 공유 기능, 저장된 결과 조회 기능, 기타 운영자가 서비스와 관련하여 제공하는 모든 부가 기능에 적용됩니다. 사용자가 특정 기능을 실제로 사용하지 않았더라도 서비스에 접근하거나 분석 절차를 개시한 경우에는 해당 기능과 관련된 제한 및 면책 조항이 함께 적용될 수 있습니다.",
    ],
  },
  {
    title: "제2조 서비스의 성격",
  ...
  },
  {
    ...
    body: [
      ...
      "사용자는 타인의 얼굴을 무단으로 분석하는 행위, 결과를 조작하여 제3자를 모욕하는 행위, 서비스 결과를 실제 신상 평가나 괴롭힘 자료로 사용하는 행위, 차별적 목적으로 사용하는 행위, 운영자의 의도와 무관하게 서비스 명칭 또는 결과물을 사칭하는 행위, 리버스 엔지니어링 또는 보안 취약점 악용 행위를 해서는 안 됩니다.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "사용자가 서비스에 입력하거나 카메라로 제공한 본인 이미지에 대한 권리는 원칙적으로 사용자에게 있으나, 사용자는 서비스가 분석 수행, 결과 페이지 생성, 오류 확인, 품질 개선, 남용 방지 및 운영상 필요한 범위에서 해당 입력물을 처리할 수 있도록 허락합니다.",
    ],
  },
  {
